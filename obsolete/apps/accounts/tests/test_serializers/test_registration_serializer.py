...
from obsolete.apps.accounts.api.v1.serializers.registration import RegistrationSerializer
from obsolete.apps.accounts.exceptions import InvalidPasswordError
