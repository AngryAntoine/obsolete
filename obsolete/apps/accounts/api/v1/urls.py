...
from obsolete.apps.accounts.api.v1.views.login import LoginView, LogoutView
from obsolete.apps.accounts.api.v1.views.password import (
    ChangePasswordAPIView,
    ConfirmResetPasswordAPIView,
    ResetPasswordAPIView,
)
from obsolete.apps.accounts.api.v1.views.registration import RegistrationAPIView
from obsolete.apps.accounts.api.v1.views.user_profile import UserProfileAPIView
