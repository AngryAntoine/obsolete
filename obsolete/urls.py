...
api_v1_urlpatterns = [
    path(
        ...
        include(("obsolete.apps.accounts.api.v1.urls", "accounts"), namespace="api-v1-accounts"),
    )
]
...
# enable Swagger
if "SWAGGER" in settings.OBSOLETE_FEATURES:
    ...
    api_v1_schema_view = get_schema_view(
        openapi.Info(
            title="obsolete",
            default_version="v1",
            description="obsolete API v1 description",
        ),
        public=True,
